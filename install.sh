...
install_XrayR() {
    ...
    file="https://github.com/snddman/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/snddman/XrayR-release/master/XrayR.sh
