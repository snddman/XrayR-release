...
install_XrayR() {
    ...
    file="https://github.com/snddman/XrayR-release/raw/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/snddman/XrayR-release/main/XrayR.sh
